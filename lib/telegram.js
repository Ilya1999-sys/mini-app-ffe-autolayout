...
const { discountForScore } = require("./quiz");
...
async function sendProductChoices(userId, score, token = getBotToken()) {
  return telegramApi("sendMessage", {
    chat_id: userId,
    text: `Результат теста: ${score} из 7. Вам доступна скидка ${discountForScore(score)}%. Выбирайте продукт, на который хотите получить промокод на скидку.`,
